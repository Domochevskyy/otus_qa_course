...
from .admin_page_locators import AuthAdminPageLocators, AdminPageLocators, ProductsPageLocators, CustomersPageLocators
...
class ProductsPage(BasePage):
    ...
    def add_product(self, name: str = None, tag_title: str = None, model: str = None) -> None:
        ...
        try:
            ...
            logging.info(f'Can not close message')
